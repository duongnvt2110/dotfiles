...
1. Literal Translation: Translate content directly into Chinese while keeping technical terms unchanged
2. Issue Identification: Identify awkward phrasing, unnatural expressions, or unclear parts IN CHINESE
3. Reinterpretation: Produce a polished Chinese translation that reads naturally and fluently while maintaining technical precision

## Output Format:
Output ONLY the final reinterpreted Chinese translation. No explanations. No additional commentary.

---
Translate the following English or Japanese tech content into Chinese:
$ARGUMENTS
