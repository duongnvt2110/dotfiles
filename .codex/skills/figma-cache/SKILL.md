---
name: figma-cache
description: Cache-first Figma MCP workflow for design context, screenshots, variables, and assets with 429 asset fallback via agent-browser. Use for any Figma URL or when users need reliable Figma extraction with cache preference.
---
