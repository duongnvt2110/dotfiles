...
description: "Cache-first Figma design-to-code workflow with 1:1 visual fidelity and 429 asset fallback via agent-browser. Trigger when the user provides Figma URLs or node IDs, or asks to implement designs/components that must match Figma specs."
---
