---
name: rfc-writer
description: "Draft and facilitate Request for Comments documents for non-trivial technical changes with multiple viable options, cross-team impact, or meaningful risk."
---
