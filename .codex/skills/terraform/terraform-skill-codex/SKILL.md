---
name: terraform-skill-codex
description: "Use when working with Terraform or OpenTofu - creating modules, writing tests (native test framework, Terratest), setting up CI/CD pipelines, reviewing."
---
...
- Basic Terraform/OpenTofu syntax questions (Codex already handles this)
